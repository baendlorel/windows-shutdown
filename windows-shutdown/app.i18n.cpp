...
void AppI18N::SetLang(Lang lang) {
    if (lang == Lang::Zh) {
        ...
        //     WIDEN(CFG_KEY_INSTRUCTION), WIDEN(CFG_INSTRUCTION_SHOW), WIDEN(CFG_INSTRUCTION_HIDE),
        //     WIDEN(CFG_INSTRUCTION_SHOW));
        ...
        // this->ErrResourceNotFound = L"Icon resource file not found! The program may be
        // corrupted."; this->ErrLoadResource = L"Failed to load icon resource! The program may be
        // corrupted."; this->ErrCreateImageStream = L"Failed to create image stream!";
        ...
        //     WIDEN(CFG_KEY_LANG), WIDEN(CFG_LANG_ZH), WIDEN(CFG_LANG_EN), WIDEN(CFG_LANG_EN));
        // this->InvalidAction =
        ...
        // this->AuthorInfo = L"Welcome to https://baendlorel.github.io/ for more interesting
        // apps\n";
